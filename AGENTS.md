# AGENTS.md — Sovereign Scripts (`/home/toxic/projects/sovereign-scripts`)

**Role**: Reusable automation scripts, batch tooling, and maintenance routines for sovereign infrastructure.
**Stack**: Python (asyncio/aiohttp), Bash, Node/Bun.

---

## 🎯 Repository Specifics

- No monolithic blocking scripts: use backgrounding with PID tracking.
- Fail loud: never swallow return codes.
